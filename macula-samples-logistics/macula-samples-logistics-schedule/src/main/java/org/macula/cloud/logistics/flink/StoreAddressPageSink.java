...
@Slf4j
public class StoreAddressPageSink extends RichSinkFunction<PageRequest> {

	private static final long serialVersionUID = 1L;

	public static StoreAddressRepository storeAddressRepository;
	...
	public static void initializeBeans(StoreAddressRepository repository, CainiaoLinkService service) {
	...
	public void invoke(PageRequest pageRequest, @SuppressWarnings("rawtypes") Context context) throws Exception {
		...
		Page<StoreAddress> addressPage = storeAddressRepository.findUnloadMappings(pageRequest);
