...
public class POrderHeader {
	...
	public String getPoEntryTime() {
		return poEntryTime;
	}

	public void setPoEntryTime(String poEntryTime) {
	...
	public String getKunn1Distric() {
		return kunn1Distric;
	}

	public void setKunn1Distric(String kunn1Distric) {
		this.kunn1Distric = kunn1Distric;
	}
	...
	/**
	 * @param pay_kunn the pay_kunn to set
	 */
