...
public class ProductQuantity implements Serializable {
	...
	/**
	 * 履行仓库库区(for fulfilment)
	 */
	private String fulfilmentWhCode;

	/**
	 * 履行执行仓库库区
	 */
	private String fulfilmentLocCode;

	/**
	 * 履行产品数量
	 */
	private BigDecimal fulfilmentQuantity = BigDecimal.ZERO;
	...
	public int hashCode() {
		...
		result = prime * result + ((fulfilmentWhCode == null) ? 0 : fulfilmentWhCode.hashCode());
		return result;
	}
