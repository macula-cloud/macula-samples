...
@FeignClient(value = "macula-samples-stock-api", path = "/api/scmp/stock", fallbackFactory = StockFeignClientFallbackFactory.class)
public interface StockFeignClient {
	...
	@PostMapping(value = "/fulfilment")
	ResponseEntity<InventoryResponse> fulfilment(@RequestBody InventoryRequest request);
